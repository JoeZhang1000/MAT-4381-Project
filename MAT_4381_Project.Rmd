...
There's another way to test whether predictors are significant to the model, but instead of testing individual parameters only, we can test a subset of all parameters. This is known as the ANOVA test. We won't explore this in detail as this is not the primary topic of this paper.
