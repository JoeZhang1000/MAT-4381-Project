...
train_set_indices <- createDataPartition(boston_housing_dataset$MEDV, p = 0.2, list = FALSE)
...
ggplot(boston_housing_dataset, aes(x = MEDV)) +
  geom_histogram(bins = 60, fill = "blue", color = "black") + # Increased number of bins
  labs(title = "Histogram of MEDV with More Bins",
       x = "Median Value of Homes ($1000s)",
       y = "Frequency") +
  theme_minimal()
...
beta_extra_info = pd.DataFrame()
beta_extra_info['OLS Beta SE Estimate'] = OLS_beta_estimates['standardError']
beta_extra_info['Bayesian Beta SD Estimate'] = beta_estimates['SD Estimate for Beta']
