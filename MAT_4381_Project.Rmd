...
For the prior for $\sigma^2$, we used the $IG(a, b)$ prior with $a = 5$ and $b = 75$. 
...
Table 3: $\beta$ Coefficient Estimates $95\%$ Confidence Intervals/Credible Region Comparison between OLS and Bayesian method
```
