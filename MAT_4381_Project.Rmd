...
for i in range(num_predictors):
    ...
    #subaxis.set_xlabel('$\\beta$' + str(i) + ' Value', fontsize=25)
    subaxis.set_ylabel('Frequency', fontsize=25)
    subaxis.set_title('$X_{' + str(i) + '}$ Value (' + train_set.columns[i] + ')', fontsize=3)
    #subaxis.set_title('$X$ ' + str(i) + ' Value (' + train_set.columns[i] + ')', fontsize=3)
...
fig.suptitle('Simulated Marginal Posterior Distributions and Credible Regions for Beta Coefficients of Predictors', fontsize=40, y=0.98)
